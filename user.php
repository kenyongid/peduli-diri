        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="?url=catatan_perjalanan">
                    ...
                    <span>Catatan Perjalan</span></a>

            <li class="nav-item">
                <a class="nav-link" href="?url=unduh">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    <h3>App Peduli Diri-Aplikasi Pencatat Riwayat Perjalanan</h3>
                </nav>
                <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <div class=" mb-4 text-gray-800">
                        ...
                        if(!empty(@$_GET['url'])){
                            ...
                            echo"Selamat Datang Di App Peduli Diri, Aplikasi ini digunakan untuk mencatat riwayat perjalanan.";
                            echo"<br>Anda Masuk Sebagai : ";
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; App Peduli Diri</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
