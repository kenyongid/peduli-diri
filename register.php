...
<link rel="icon" 
    ...
    <title>App Peduli Diri - Daftar</title>
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Daftar Akun Peduli Diri!</h1>
                                    ...
                                    <form class="user" method="post" action="proses_register.php">
                                        ...
                                        <a href="index.php" class="btn btn-facebook btn-user btn-block">
                                             <i class="fas fa-arrow-circle-left"></i> sudah Punya Akun..? Klik Di sini 
                                        </a>
                                    </form>
                                </div>
                            </div>
